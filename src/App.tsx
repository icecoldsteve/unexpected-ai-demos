...
function AIReceptionistDemo() {
  ...
  const generateAIResponse = (userMsg: string): string => {
    ...
    if (msg.includes('brake') || msg.includes('noise') || msg.includes('grinding')) {
      return "Thanks for letting me know. Grinding brakes are usually pads or rotors. Can you tell me the make, model, and year of your vehicle? Also, when did the noise start?"
    }
    if (msg.includes('oil') || msg.includes('change')) {
      return "We have openings this Thursday and Friday afternoon. Would 2pm or 4pm work better for you? I can book that right now."
    }
    if (msg.includes('price') || msg.includes('cost') || msg.includes('how much')) {
      return "Transmission flush is typically $189–$249 depending on fluid type. Want me to check your vehicle’s recommended service and send a quote?"
    }
    if (msg.includes('yes') || msg.includes('book') || msg.includes('appointment')) {
      return "Perfect! I've blocked Thursday at 2pm for you. Can I get your name and phone number so Mike can confirm the morning of?"
    }
    return "Got it. To give you the best answer, could you share a bit more detail about the vehicle or the issue you're having?"
  }
